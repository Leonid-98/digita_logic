...
set_property PACKAGE_PIN T2 [get_ports {address_bin[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {address_bin[0]}]
set_property PACKAGE_PIN R3 [get_ports {address_bin[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {address_bin[1]}]
#set_property PACKAGE_PIN W2 [get_ports {sw[12]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[12]}]
#set_property PACKAGE_PIN U1 [get_ports {sw[13]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[13]}]
set_property PACKAGE_PIN T1 [get_ports {we_bin[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {we_bin[0]}]
set_property PACKAGE_PIN R2 [get_ports {we_bin[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {we_bin[1]}]
