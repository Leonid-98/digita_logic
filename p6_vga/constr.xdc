...
set_property PACKAGE_PIN W15 [get_ports {GRN_IN[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {GRN_IN[4]}]
set_property PACKAGE_PIN V15 [get_ports {GRN_IN[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {GRN_IN[5]}]
set_property PACKAGE_PIN W14 [get_ports {GRN_IN[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {GRN_IN[6]}]
set_property PACKAGE_PIN W13 [get_ports {GRN_IN[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {GRN_IN[7]}]
set_property PACKAGE_PIN V2 [get_ports {BLU_IN[8]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {BLU_IN[8]}]
set_property PACKAGE_PIN T3 [get_ports {BLU_IN[9]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {BLU_IN[9]}]
set_property PACKAGE_PIN T2 [get_ports {BLU_IN[10]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {BLU_IN[10]}]
set_property PACKAGE_PIN R3 [get_ports {BLU_IN[11]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {BLU_IN[11]}]
